...
public class PropertiesUtils {
    private static final ResourceLoader loader = ResourceLoader.getInstance();
    private static final ConcurrentMap<String, String> configMap = new ConcurrentHashMap<String, String>();
